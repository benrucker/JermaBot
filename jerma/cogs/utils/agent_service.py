...
it. Interim narration is streamed through the on_progress callback; the
answer and other outcomes come back in a TaskReport.
"""
import asyncio
...
class AgentTaskService:
    ...
    async def run(self, prompt: str, on_progress: OnProgress) -> TaskReport:
